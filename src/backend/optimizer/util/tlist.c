 ...
 *
 * Returns the "flattened" new__ target list.
 *
 * The result is entirely new__ structure sharing no nodes with the original.
 ...
 *
 * Note: this__ function is used to decide whether it's safe to jam a new__ tlist
