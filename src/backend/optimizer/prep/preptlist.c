				  ...
				  Index result_relation, List *range_table)
{
	...
	for (attrno = 1; attrno <= numattrs; attrno++)
	{
		...
		if (new_tle == NULL)
		{
			 ...
			 * the attribute, so that it gets copied to the new__ tuple. But
	 ...
	 * end of the new__ tlist, making sure they have resnos higher than the last
