...
static void AddNewRelationTuple(Relation pg_class_desc,
					...
					Datum relacl,
					Datum reloptions);
static ObjectAddress AddNewRelationType(const char *typename__,
				   Oid typeNamespace,
				   Oid new_rel_oid,
				   char new_rel_kind,
				   Oid ownerid,
 ...
 * table of a particular class__/type. In any case table is still the word
 * used in SQL.
 */
 ...
 *
 *		this registers the new__ relation's schema by adding
 ...
 *		AddNewRelationTuple
 *
 *		this registers the new__ relation in the catalogs by
...
AddNewRelationType(const char *typename__,
				   Oid typeNamespace,
				   Oid new_rel_oid,
				   char new_rel_kind,
				   Oid ownerid,
