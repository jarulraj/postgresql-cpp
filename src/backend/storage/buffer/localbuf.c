				 ...
				 bool *foundPtr)
{
	...
	/*
	 * Need to get a new__ buffer.  We use a clock sweep algorithm (essentially
	...
	/*
	 * Update the hash table: remove old entry, if any, and make new__ one.
	 */
...
GetLocalBufferStorage(void)
{
	...
	{
		/* Need to make a new__ request to memmgr */
		int			num_bufs;
