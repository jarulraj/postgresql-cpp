...
/*
 * Backend-private__ refcount management:
 *
 * Each buffer also has a private__ refcount that keeps track of the number of
 ...
 * searching the private__ refcount array & hash, which is a boon, because the
...
FlushBuffer(volatile BufferDesc *buf, SMgrRelation reln)
{
	 ...
	 * copy the page to private__ storage if we do checksumming.
	 */
