...
/*
 * When a public__ interface method is called for a read, this is the test to
...
/*
 * Call this whenever there is a new__ xmin for active serializable
 ...
 * always this same pointer; no new__ snapshot data structure is allocated
								...
								Snapshot snapshot)
{
	...
	switch (htsvResult)
	{
		...
		default:
			...
			/*
			 * The only way to get to this default clause is if a new__ value is
