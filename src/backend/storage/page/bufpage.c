			...
			bool is_heap)
{
	...
	/*
	 * Select offsetNumber to place the new__ item at
	 */
	...
	/*
	 * Compute new__ lower and upper pointers for page, see if it'll fit.
	 *
...
/*
 * Set checksum for a page in private__ memory.
 *
