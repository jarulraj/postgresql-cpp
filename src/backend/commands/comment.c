 ...
 * CreateComments --
 *
 * Create a comment for the specified object descriptor.  Inserts a new__
...
CreateComments(Oid oid, Oid classoid, int32 subid, char *comment)
{
	...
	/* If we didn't find an old tuple, insert a new__ one */
 ...
 * new__ pg_shdescription tuple, or replaces an existing one with the same key.
 *
 * If the comment given is null or an empty string, instead delete any
 * existing comment for the specified key.
 */
