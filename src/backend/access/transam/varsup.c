...
/*
 * Allocate the next XID for a new__ transaction or subtransaction.
 *
 * The new__ XID is also stored into MyPgXact before returning.
 *
...
GetNewTransactionId(bool isSubXact)
{
	 ...
	 * operation, so we can't account for new__ XIDs after that point.
	 */
	if (IsInParallelMode())
	...
	/*
	 * If we are allocating the first XID of a new__ page of the commit log,
	...
	/*
	 * We must store the new__ XID into the shared ProcArray before releasing
	 ...
	 * race-condition window, in that the new__ XID will not appear as running
...
/*
 * GetNewObjectId -- allocate a new__ OID
 *
