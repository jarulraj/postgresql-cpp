 ...
 * be safe to assign that ID to a new__ timeline.
 */
TimeLineID
...
/*
 * Create a new__ timeline history file.
 *
 *	newTLI: ID of the new__ timeline
 *	parentTLI: ID of its immediate parent
 *	switchpoint: XLOG position where the system switched to the new__ timeline
