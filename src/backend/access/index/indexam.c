 ...
 *
 * During a restart, the caller may specify a new__ set of scankeys and/or
 ...
 *		not directly the implementation of any WHERE-clause query operator__
 ...
 *
 *		As of Postgres 8.3, support routines within an operator__ family
 *		are further subdivided by the "left type" and "right type" of the
 *		query operator__(s) that they support.  The "default" functions for a
