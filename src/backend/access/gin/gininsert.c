 ...
 * GinFormTuple().  Returns a new__, modified index tuple.
						   ...
						   GinStatsData *buildStats)
{
	...
	/* merge the old and new__ posting lists */
	...
	if (!res)
	{
		...
		/* And build a new__ posting-tree-only result tuple */
					...
					GinStatsData *buildStats)
{
	...
	if (!res)
	{
		...
		/*
		 * Initialize a new__ posting tree with the TIDs.
		 */
			   ...
			   GinStatsData *buildStats)
{
	...
	{
		/* no match, so construct a new__ leaf entry */
		itup = buildFreshLeafTuple(ginstate, attnum, key, category,
								   items, nitem, buildStats);
	}

	/* Insert the new__ or modified leaf tuple */
