...
_hash_first(IndexScanDesc scan, ScanDirection dir)
{
	...
	/* And there's only one operator__ strategy, too */
	 ...
	 *
	 * If scankey operator__ is not a cross-type comparison, we can use the
	...
	do
	{
		switch (dir)
		{
			case ForwardScanDirection:
				...
				{
					/* new__ page, locate starting position by binary search */
