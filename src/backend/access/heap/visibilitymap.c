 ...
 * one provided; in normal running, we generate a new__ XLOG record and set the
 ...
 * extended concurrently with the call.  new__ pages added to the table aren't
 ...
 *
 * nheapblocks is the new__ size of the heap.
 */
void
visibilitymap_truncate(Relation rel, BlockNumber nheapblocks)
{
	...
	/*
	 * Unless the new__ size is exactly at a visibility map page boundary, the
