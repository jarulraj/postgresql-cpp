			...
			HeapUpdateFailureData *hufd, LockTupleMode *lockmode)
{
	...
	/* the new__ tuple is ready, except for this: */
...
l2:
	 ...
	 * info in the old tuple's Xmax.  Prepare a new__ Xmax value for this.
	 */
 ...
 *
 * Note that this might have side effects such as creating a new__ MultiXactId.
 *
 ...
 * xid with the given mode; if this tuple is updated, recurse to lock the new__
 * version as well.
 */
static HTSU_Result
...
heap_inplace_update(Relation relation, HeapTuple tuple)
{
	 ...
	 * pass the new__ version of the tuple, this mustn't be used for any
 ...
 *		MultiXactId.
 *
 * NB -- this might have the side-effect of creating a new__ MultiXactId!
 *
				  ...
				  uint16 *flags)
{
	...
	*flags = 0;
	...
	else if (TransactionIdIsValid(update_xid) && !has_lockers)
	{
		 ...
		 * without creating a new__ Multi.  (XXX we could do this when there's a
				...
				bool all_visible_cleared, bool new_all_visible_cleared)
{
	 ...
	 *
	 * We could do this even if the old and new__ tuple are on different pages,
	 ...
	 *
	 * Skip this if we're taking a full-page image of the new__ page, as we
