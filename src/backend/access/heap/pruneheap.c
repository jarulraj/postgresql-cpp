...
typedef struct
{
	TransactionId new_prune_xid;	/* new__ prune hint value for page */
...
heap_page_prune_opt(Relation relation, Buffer buffer)
{
	 ...
	 * for a new__ tuple version, or when free space falls below the relation's
 ...
 * send its own new__ total to pgstats, and we don't want this__ delta applied
 * on top of that.)
 *
				...
				bool report_stats, TransactionId *latestRemovedXid)
{
	 ...
	 *
	 * First, initialize the new__ pd_prune_xid value to zero (indicating no
	...
	{
		/*
		 * If we didn't prune anything, but have found a new__ value for the
