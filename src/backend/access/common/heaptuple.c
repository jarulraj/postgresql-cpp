 ...
 * This is deprecated and should not be used in new__ code, but we keep it
...
/*
 * heap_modify_tuple
 *		form a new__ tuple from an old tuple and a set of replacement values.
 *
 * The replValues, replIsnull, and doReplace arrays must be of the length
 * indicated by tupleDesc->natts.  The new__ tuple is constructed using the data
				  ...
				  bool *doReplace)
{
	...
	/*
	 * create a new__ tuple from the values and isnull arrays
	 */
 ...
 *		heap_modifytuple
 *
 *		forms a new__ tuple from an old tuple and a set of replacement values.
 *		returns a new__ palloc'ed tuple.
 *
