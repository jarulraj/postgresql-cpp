 ...
 *
 * Attempt to create a new__ shared memory segment with the specified key.
...
InternalIpcMemoryCreate(IpcMemoryKey memKey, Size size)
{
	...
	/* Register on-exit routine to detach new__ segment before deleting */
