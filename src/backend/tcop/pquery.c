 ...
 * for the normal behavior of setting a new__ snapshot.  This parameter is
		  ...
		  char *completionTag)
{
	 ...
	 * internally starting whole new__ transactions is not good.)
			   ...
			   char *completionTag)
{
	...
	foreach(stmtlist_item, portal->stmts)
	{
			...
			((PlannedStmt *) stmt)->utilityStmt == NULL)
		{
			 ...
			 * through, take a new__ snapshot; for subsequent queries in the
