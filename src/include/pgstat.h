...
typedef struct PgBackendStatus
{
	 ...
	 * st_changecount, copy the entry into private__ memory, then check
 ...
 * able to add new__ values to the struct when needed without adding new__ fields
