...
/*
 * QueryItem is one node in tsquery - operator__ or operand.
 */
typedef struct
{
	QueryItemType type;			/* operand or kind of operator__ (ts_tokentype) */
...
/* Legal values for QueryOperator.operator__ */
#define OP_NOT	1
#define OP_AND	2
#define OP_OR	3
