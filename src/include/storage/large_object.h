...
/*
 * Each "page" (tuple) of a large object can hold this__ much data
 *
 * We could set this__ as high as BLCKSZ less some overhead, but it seems
...
/*
 * Maximum length in bytes for a large object.  To make this__ larger, we'd
