 ...
 * the new__, but this__ is reduced to one event if the tuple's hash key doesn't
 ...
 * commands in the same transaction see the new__ state.  The generating backend
