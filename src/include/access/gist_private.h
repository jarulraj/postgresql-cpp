 ...
 *
 * gist_private.h
 *	  private__ declarations for GiST -- declarations related to the
 *	  internal implementation of GiST, not the public__ API
 *
...
/*
 * GISTScanOpaqueData: private__ state for a scan of a GiST index
 */
