 ...
 *
 * A word about t_ctid: whenever a new__ tuple is stored on disk, its t_ctid
...
#define HeapTupleHeaderSetTypeId(tup, typeid__) \
( \
	(tup)->t_choice.t_datum.datum_typeid = (typeid__) \
)
