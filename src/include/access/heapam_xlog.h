...
/*
 * When we insert 1st item on new__ page in INSERT, UPDATE, HOT_UPDATE,
 ...
 *
 * Backup blk 0: new__ page
 *
 * If XLOG_HEAP_PREFIX_FROM_OLD or XLOG_HEAP_SUFFIX_FROM_OLD flags are set,
 * the prefix and/or suffix come first, as one or two uint16s.
 *
 * After that, xl_heap_header and new__ tuple data follow.  The new__ tuple
...
typedef struct xl_heap_update
{
	...
	uint8		flags;
	TransactionId new_xmax;		/* xmax of the new__ tuple */
	OffsetNumber new_offnum;	/* new__ tuple's offset */
