...
/*
 * When we insert the first item on a new__ page, we restore the entire page in
 * redo.
 */
 ...
 *
 * Backup block 0: main page, block data is the new__ BrinTuple.
 ...
 * Backup block 0: new__ page, block data includes the new__ BrinTuple.
 * Backup block 1: revmap page
 *
 * And in addition:
 ...
 *
 * Backup block 0: updated page, with new__ BrinTuple as block data
 */
 ...
 *
 * Backup block 0: metapage
 * Backup block 1: new__ revmap page
 */
