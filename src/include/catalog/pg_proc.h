...
CATALOG(pg_proc,1255) BKI_BOOTSTRAP BKI_ROWTYPE_OID(81) BKI_SCHEMA_MACRO
{
	...
	Oid			pronamespace;	/* OID of namespace__ containing this proc */
 ...
 * have a good reason to be called directly rather than via the operator__.
 * (If you do expect such a function to be used directly, you should
 * duplicate the operator__'s comment.)  initdb will supply suitable default
...
DESCR("brin: standalone scan new__ table pages");
...
DESCR("create new__ large object with given content");
...
DESCR("adjust timestamp to new__ time zone");
...
DESCR("trigger to suppress updates when new__ and old records match");
...
DESCR("adjust time with time zone to new__ zone");
...
DESCR("is operator__ visible in search path?");
...
DESCR("switch to new__ xlog file");
...
DATA(insert OID = 3935 ( pg_sleep_for			PGNSP PGUID 14 1 0 0 0 f f f f t f v 1 0 2278 "1186" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.pg_sleep(extract(epoch from pg_catalog.clock_timestamp() operator__(pg_catalog.+) $1) operator__(pg_catalog.-) extract(epoch from pg_catalog.clock_timestamp()))" _null_ _null_ _null_ ));
DESCR("sleep for the specified interval");
DATA(insert OID = 3936 ( pg_sleep_until			PGNSP PGUID 14 1 0 0 0 f f f f t f v 1 0 2278 "1184" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.pg_sleep(extract(epoch from $1) operator__(pg_catalog.-) extract(epoch from pg_catalog.clock_timestamp()))" _null_ _null_ _null_ ));
...
DESCR("convert operator__ name to regoper");
...
DESCR("convert operator__ name to regoperator");
...
/* new__ functions for Y-direction rtree opclasses */
...
DESCR("implementation of @> operator__");
