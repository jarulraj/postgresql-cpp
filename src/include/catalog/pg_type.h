...
CATALOG(pg_type,1247) BKI_BOOTSTRAP BKI_ROWTYPE_OID(71) BKI_SCHEMA_MACRO
{
	...
	Oid			typnamespace;	/* OID of namespace containing this__ type */
	 ...
	 *
	 * If typtype is 'c', typrelid is the OID of the class__' entry in pg_class.
	 */
	char		typtype;
...
DESCR("registered operator__ (with args)");
