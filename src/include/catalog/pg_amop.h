 ...
 *
 * The amop table identifies the operators associated with each index operator__
 * family and operator__ class__ (classes are subsets of families).  An associated
...
#define AMOP_SEARCH		's'		/* operator__ is for search */
#define AMOP_ORDER		'o'		/* operator__ is for ordering */
