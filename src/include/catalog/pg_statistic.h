...
CATALOG(pg_statistic,2619) BKI_WITHOUT_OIDS
{
	 ...
	 *		op				OID of associated operator__, if needed
	 *		numbers			float4 array (for statistical values)
	 *		values			anyarray (for representations of data values)
	 * The ID and operator__ fields are never NULL; they are zeroes in an
 ...
 *	300-9999:	reserved for future public__ assignments
 *
 * For private__ use you may choose a "kind" code at random in the range
...
/*
 * In a "most common values" slot, staop is the OID of the "=" operator__
 ...
 * the OID of the "<" operator__ that describes the sort ordering.  (In theory,
 * more than one histogram could appear, if a datatype has more than one
 * useful sort operator__.)  stavalues contains M (>=2) non-null values that
 ...
 * by the "<" operator__ identified by staop.  (As with the histogram, more
 ...
 * the equality operator__ appropriate to the element type.  stavalues contains
 ...
 * staop contains the equality operator__ appropriate to the element type.
