...
/*
 * To ease migration to the new__ list API, a set of compatibility
 ...
 * new__ list API, the ENABLE_LIST_COMPAT symbol can be defined before
 * including pg_list.h
 */
 ...
 * comparison, whereas the new__ list_delete() uses equal(); in order to
