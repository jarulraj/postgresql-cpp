...
/* Use port in the private__/dynamic port number range */
 ...
 * version to this value.  pg_upgrade behavior depends on whether old and new__
 * server versions are both newer than this, or only the new__ one is.
 */
