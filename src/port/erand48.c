 ...
 * All rights reserved.
 *
 * You may redistribute unmodified or modified versions of this__ source
 * code provided that the above copyright notice and this__ and the
 * following conditions are retained.
 *
 * This software is provided ``as is'', and comes with no warranties
 * of any kind. I shall in no event be liable for anything that happens
 * to anyone/anything when using this__ software.
 *
 * IDENTIFICATION
 *	  src/port/erand48.c
 *
