...
typedef struct pgNotify
{
	...
	/* Fields below here are private__ to libpq; apps should not use 'em */
...
/* make a new__ client connection to the backend */
...
/*
 * close the current connection and restablish a new__ one with the same
 * parameters
 */
/* Asynchronous (non-blocking) */
...
extern Oid	PQoidValue(const PGresult *res);	/* new__ and improved */
