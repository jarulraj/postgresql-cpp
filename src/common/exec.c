...
AddUserToTokenDacl(HANDLE hToken)
{
	...
	/* Figure out the size of the new__ ACL */
	...
	/* Loop through the existing ACEs, and build the new__ ACL */
	...
	/* Add the new__ ACE for the current user */
	...
	/* Set the new__ DACL in the token */
